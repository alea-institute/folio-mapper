        ...
        */}
        ...
        {onOpenSettings && llmStatus === 'connected' && (
          <button
            ...
            className="flex items-center gap-1.5 rounded px-2 py-1.5 text-xs text-gray-400 hover:bg-gray-100 hover:text-gray-600"
            title={llmProviderLabel ? `Connected to ${llmProviderLabel} — click to configure` : 'LLM connected — click to configure'}
        ...
        {onOpenSettings && llmStatus === 'disconnected' && (
          <button
            type="button"
            onClick={onOpenSettings}
        ...
        {onOpenSettings && llmStatus !== 'connected' && llmStatus !== 'disconnected' && (
          <button
            onClick={onOpenSettings}
